...
\subsection*{Εκτίμηση παραμέτρων με την μέθοδο \selectlanguage{english}Lyapunov\selectlanguage{greek}}

Θα σχεδιάσουμε εκτιμητή πραγματικού χρόνου των άγνωστων παραμέτρων με τη μέθοδο 
\selectlanguage{english}Lyapunov\selectlanguage{greek} θεωρώντας $d(t) = 0$.
...
\selectlanguage{english}Lyapunov\selectlanguage{greek}:
\begin{equation}
...
Θα επαναλάβουμε την εκτίμηση των παραμέτρων με τη μέθοδο \selectlanguage{english}Lyapunov\selectlanguage{greek},
...
Η συνάρτηση \selectlanguage{english}Lyapunov\selectlanguage{greek} παραμένει ως έχει στην 
...
\begin{minipage}[t]{0.45\textwidth}
    ...
    \captionof{figure}{Σφάλμα αναγνώρισης με τη μέθοδο \selectlanguage{english}Lyapunov\selectlanguage{greek}}
...
\begin{minipage}[t]{0.45\textwidth}
    ...
    \captionof{figure}{Εκτιμήσεις παραμέτρων με τη μέθοδο \selectlanguage{english}Lyapunov\selectlanguage{greek}}
...
\begin{figure}[h!]
    ...
    \end{subfigure}
    \caption{Σφάλμα αναγνώρισης με τη μέθοδο \selectlanguage{english}Lyapunov\selectlanguage{greek}
...
\begin{figure}[h!]
    ...
    \end{subfigure}
    \caption{Εκτιμήσεις παραμέτρων με τη μέθοδο \selectlanguage{english}Lyapunov\selectlanguage{greek}
    παρουσία διαταραχών με α) $\psi = 0.1$, β) $\psi = 10$}
