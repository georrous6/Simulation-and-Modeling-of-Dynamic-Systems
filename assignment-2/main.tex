...
Επίσης, ο πίνακας $A$ είναι αρνητικά ημιορισμένος καθώς οι ιδιοτιμές του βρίσκονται στο αρνητικό ημιεπίπεδο. 
H (Π) δομή συστήματος αναγνώρισης είναι:
\begin{equation*}
    \dot{\hat{x}} = \hat{A}\hat{x} + \hat{B} u,
\end{equation*}
όπου $\hat{x}$ η εκτίμηση του διανύσματος καταστάσεων και $\hat{A}, \, \hat{B}$ οι εκτιμήσεις των $A, \, B$.
Οι νέες εκτιμήσεις των $A, \, B$ επιλέγονται, η μαθηματική ανάλυση των οποίων παραλείπεται, από τις σχέσεις:
\begin{equation*}
    \begin{aligned}
        &\dot{\hat{A}} = \hat{x}e^T \\
        &\dot{\hat{B}} = u e^T,
    \end{aligned}
\end{equation*}
όπου $e = x - \hat{x}$ το σφάλμα αναγνώρισης. 
